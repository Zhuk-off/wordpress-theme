        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="183" title="Оставьте ваш вопрос здесь Ваше имя *"]') ?>
            </div>
        </div>
        <footer>
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('instagram_link', 2) ?>" target="_blank" class="footer__social-item">
                            ...
                            <a href="<?php the_field('facebook_link', 2) ?>" target="_blank" class="footer__social-item">
                            ...
                            <a href="<?php the_field('youtube_link', 2) ?> " target="_blank" class="footer__social-item">
